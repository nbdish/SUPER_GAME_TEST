...
public:
    ...
    void spawnSprite(cocos2d::Sprite* s, int layer, double scale);
    virtual void spawnSprite(cocos2d::Sprite* s, int layer, double scale, int x,int y);
    int collisionSprites(cocos2d::Sprite* s1, cocos2d::Sprite* s2);
};
